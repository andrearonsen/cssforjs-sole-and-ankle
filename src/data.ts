...
const SHOES: Shoe[] = [
  {
    ...
    salePrice: null,
    // 1 hour ago! 🔥
    releaseDate: new Date(Date.now() - 1000 * 60 * 60 * 1),
    numOfColors: 2,
  },
  {
    slug: "metcon-5",
  ...
  },
  {
    ...
    price: 16500,
    salePrice: null,
    releaseDate: new Date(Date.now() - 1000 * 60 * 60 * 24 * 4),
    numOfColors: 4,
  },
  {
    slug: "pegasus",
    ...
    price: 16500,
    salePrice: null,
    releaseDate: new Date(Date.now() - 1000 * 60 * 60 * 24 * 16),
    numOfColors: 1,
  },
  {
    slug: "joyride",
    ...
    price: 17000,
    salePrice: null,
    releaseDate: new Date(Date.now() - 1000 * 60 * 60 * 24 * 40),
    numOfColors: 2,
  },
  {
    slug: "legend-academy",
    ...
    price: 16500,
    salePrice: 12500,
    releaseDate: new Date(Date.now() - 1000 * 60 * 60 * 24 * 50),
    numOfColors: 8,
  },
  {
    slug: "react-infinity",
    ...
    price: 16000,
    salePrice: 14500,
    releaseDate: new Date(Date.now() - 1000 * 60 * 60 * 24 * 75),
    numOfColors: 1,
  },
  {
    ...
    price: 18500,
    salePrice: 16000,
    releaseDate: new Date(Date.now() - 1000 * 60 * 60 * 24 * 100),
    numOfColors: 4,
  },
  {
    slug: "lebron",
    ...
    price: 26000,
    salePrice: null,
    releaseDate: new Date(Date.now() - 1000 * 60 * 60 * 24 * 120),
    numOfColors: 1,
  },
];
